    ...
    for block in body_raw.split("\n\n"):
        ...
        if block.startswith("@cards"):
            ...
            if _m:
                ...
                html_parts.append(f"<p>{render_text(block)}</p>")
        elif block.startswith("@invite["):
            _m = re.match(r"@invite\[([^\]]*)\]", block)
            html_parts.append(
                f'<p class="invite">{render_text(_m.group(1) if _m else "")}'
...
audio::-webkit-media-controls-enclosure{{background:var(--paper);
 border:1px solid var(--tan);border-radius:2rem}}
...
.signs{{position:relative;display:flex;justify-content:center;align-items:stretch;
 gap:1.1rem;flex-wrap:wrap;margin:1.2rem auto 1.6rem;
 max-width:50.2rem}}
.sign{{position:relative;z-index:1;display:flex;flex-direction:column;justify-content:center;
...
@media (max-width:760px){{.vine,.vine-front{{display:none}}}}
...
.content-photo.beside{{float:left;max-width:19rem;
...
def build():
    ...
    for idx, it in enumerate(items):
        ...
        audio_html = (f'<audio controls preload="metadata" src="{AUDIO_BASE}/{_aud}" '
...
<path d="M20 104 C80 166,175 172,246 140 S350 58,452 54 S606 84,668 122 S812 166,884 140 S975 108,1000 96" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/>
<path d="M196 160 q19 -19 32 1 q-19 15 -32 -1Z" fill="currentColor"/>
<path d="M436 50 q18 -19 32 0 q-18 15 -32 0Z" fill="currentColor"/>
</svg>
<svg class="vine-front" viewBox="0 0 1000 200" preserveAspectRatio="none" aria-hidden="true">
<path d="M289.1 60.4 L290.5 60.1 L291.9 59.9 L293.3 59.8 L294.7 59.8 L296.1 60.0 L297.4 60.2 L298.7 60.6 L300.0 61.1 L301.3 61.6 L302.5 62.3 L303.7 63.1 L304.8 63.9 L305.8 64.8 L306.8 65.8 L307.8 66.9 L308.6 68.0 L309.4 69.2 L310.1 70.5 L310.7 71.7 L311.3 73.1 L311.8 74.4 L312.2 75.8 L312.5 77.2 L312.7 78.6 L312.9 80.0 L313.0 81.4 L313.0 82.8 L312.9 84.1 L312.7 85.5 L312.5 86.8 L312.2 88.1 L311.8 89.4 L311.4 90.6 L310.9 91.7 L310.4 92.8 L309.8 93.9 L309.1 94.8 L308.4 95.8 L307.7 96.6 L306.9 97.4 L306.1 98.1 L305.2 98.7 L304.4 99.3 L303.5 99.7 L302.6 100.1 L301.7 100.4 L300.8 100.7 L299.8 100.8 L298.9 100.9 L298.0 100.9 L297.1 100.8 L296.3 100.7 L295.4 100.5 L294.6 100.2 L293.8 99.9 L293.0 99.5 L292.3 99.0 L291.6 98.5 L290.9 97.9 L290.3 97.3 L289.7 96.7 L289.2 96.0 L288.7 95.2 L288.3 94.5 L287.9 93.7 L287.6 92.9 L287.3 92.1 L287.1 91.3 L286.9 90.5 L286.8 89.7 L286.7 88.9 L286.6 88.1 L286.7 87.3 L286.7 86.5 L286.8 85.7 L287.0 85.0 L287.1 84.3 L287.4 83.6 L287.6 82.9 L287.9 82.3 L288.2 81.7 L288.6 81.2 L289.0 80.7 L289.3 80.2 L289.8 79.8 L290.2 79.5 L290.6 79.1 L291.1 78.9 L291.5 78.6 L292.0 78.5 L292.4 78.3 L292.9 78.2 L293.3 78.2 L293.8 78.1 L294.2 78.2 L294.6 78.2 L295.0 78.3 L295.4 78.5 L295.8 78.6 L296.1 78.8 L296.4 79.0 L296.7 79.3 L297.0 79.6 L297.3 79.8 L297.5 80.1 L297.7 80.4 L297.9 80.8 L298.0 81.1 L298.1 81.4 L298.2 81.8" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M946.9 124.6 L945.5 124.9 L944.1 125.1 L942.7 125.2 L941.3 125.2 L939.9 125.0 L938.6 124.8 L937.3 124.4 L936.0 123.9 L934.7 123.4 L933.5 122.7 L932.3 121.9 L931.2 121.1 L930.2 120.2 L929.2 119.2 L928.2 118.1 L927.4 117.0 L926.6 115.8 L925.9 114.5 L925.3 113.3 L924.7 111.9 L924.2 110.6 L923.8 109.2 L923.5 107.8 L923.3 106.4 L923.1 105.0 L923.0 103.6 L923.0 102.2 L923.1 100.9 L923.3 99.5 L923.5 98.2 L923.8 96.9 L924.2 95.6 L924.6 94.4 L925.1 93.3 L925.6 92.2 L926.2 91.1 L926.9 90.2 L927.6 89.2 L928.3 88.4 L929.1 87.6 L929.9 86.9 L930.8 86.3 L931.6 85.7 L932.5 85.3 L933.4 84.9 L934.3 84.6 L935.2 84.3 L936.2 84.2 L937.1 84.1 L938.0 84.1 L938.9 84.2 L939.7 84.3 L940.6 84.5 L941.4 84.8 L942.2 85.1 L943.0 85.5 L943.7 86.0 L944.4 86.5 L945.1 87.1 L945.7 87.7 L946.3 88.3 L946.8 89.0 L947.3 89.8 L947.7 90.5 L948.1 91.3 L948.4 92.1 L948.7 92.9 L948.9 93.7 L949.1 94.5 L949.2 95.3 L949.3 96.1 L949.4 96.9 L949.3 97.7 L949.3 98.5 L949.2 99.3 L949.0 100.0 L948.9 100.7 L948.6 101.4 L948.4 102.1 L948.1 102.7 L947.8 103.3 L947.4 103.8 L947.0 104.3 L946.7 104.8 L946.2 105.2 L945.8 105.5 L945.4 105.9 L944.9 106.1 L944.5 106.4 L944.0 106.5 L943.6 106.7 L943.1 106.8 L942.7 106.8 L942.2 106.9 L941.8 106.8 L941.4 106.8 L941.0 106.7 L940.6 106.5 L940.2 106.4 L939.9 106.2 L939.6 106.0 L939.3 105.7 L939.0 105.4 L938.7 105.2 L938.5 104.9 L938.3 104.6 L938.1 104.2 L938.0 103.9 L937.9 103.6 L937.8 103.2" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
<a class="sign first" href="/reconciled-to-god/"><span class="lab">Reconciled to God</span><span class="sub">what does it mean to be saved?</span></a>
<a class="sign" href="/reflections/"><span class="lab">Reflections</span><span class="sub">daily Scripture reflections</span></a>
<a class="sign" href="/exploring/"><span class="lab">Exploring</span><span class="sub">ways to go deeper</span></a>
