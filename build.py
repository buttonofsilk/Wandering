...
.hero{{width:100%;max-width:none;margin-top:0.8rem;aspect-ratio:16/9;height:auto;object-fit:cover;object-position:center 78%;display:block;margin-top:1.5rem}}
.sprig{{width:2.2rem;height:1.1rem;vertical-align:middle;color:var(--sage);display:inline-block}}
.sprig.flip{{transform:scaleX(-1)}}
.enter{{text-align:center;margin:1.2rem 0 1.4rem}}
