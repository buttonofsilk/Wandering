...
.hero{{width:100vw;max-width:100vw;margin-left:calc(50% - 50vw);margin-right:calc(50% - 50vw);height:30rem;object-fit:cover;object-position:center 80%;display:block;margin-top:1.5rem}}
